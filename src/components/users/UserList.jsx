    ...
    this.props.order.forEach( user_id => {
      ...
      if(abilitiesHelper.isMain() || (abilitiesHelper.isAdmin() && !abilitiesHelper.isAdmin(user))) {
        if(this.props.active) {
          activationButton = (
            <Popconfirm title="¿Seguro que quiere desactivar este usuario?" onConfirm={ this.deactivate.bind(this, user) } okText="Sí" cancelText="No">
              <Button type="danger">
                Desactivar
              </Button>
            </Popconfirm>
          ...
          activationButton = (
            <Popconfirm title="¿Seguro que quiere reactivar este usuario?" onConfirm={ this.activate.bind(this, user) } okText="Sí" cancelText="No">
              <Button type="primary">
                Activar
              </Button>
            </Popconfirm>
